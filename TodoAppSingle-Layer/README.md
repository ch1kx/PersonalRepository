...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9ac601c4-bcd8-4380-950e-b9555b6e1936
```

> `9ac601c4-bcd8-4380-950e-b9555b6e1936` is the password of the certificate, you can change it to any password you want.
