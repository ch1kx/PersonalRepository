...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2dfcb348-89fe-4064-9880-40d31932116c
```

> `2dfcb348-89fe-4064-9880-40d31932116c` is the password of the certificate, you can change it to any password you want.
